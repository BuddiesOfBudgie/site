          ...
          <AppBar position="static" color="transparent" sx={{ boxShadow: "0" }}>
            <Toolbar disableGutters={true}>
              <Stack alignItems="center" direction="row" sx={{ flexGrow: 1 }}>
                ...
                <Link href="/about" sx={{ marginInlineEnd: "2em" }} underline="none" variant="subtitle1">
                  About
                </Link>
                <Link href="/blog" sx={{ marginInlineEnd: "2em" }} underline="none" variant="subtitle1">
                  Blog
                </Link>
                <Link href="/docs" sx={{ marginInlineEnd: "2em" }} underline="none" variant="subtitle1">
                  Documentation
                </Link>
                <Button href="/get" size="large" variant="contained">
                  Get Budgie
                </Button>
              </Stack>
            </Toolbar>
