...
Budgie Desktop is developed by Buddies of Budgie and contributors from around the world. Alongside all of our amazing translators, here is a list of all the contributors that made this release possible:
