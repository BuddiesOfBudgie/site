      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <Typography align="center" variant="h5">
            With our Budgie Desktop Settings application, you can make Budgie feel like home.Whether you want a dock or
            multiple panels, you can do it with just a few clicks.
          </Typography>
          <FlexCarousel
            autoPlay={true}
            emulateTouch={true}
          ...
          >
            {images.map((imageObj) => (
              <Image alt={imageObj.text} key={`personalize-banner-${imageObj.text}`} src={imageObj.image} />
            ))}
          </FlexCarousel>
          <Chip
