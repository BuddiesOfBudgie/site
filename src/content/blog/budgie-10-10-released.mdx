...
- **Screen Locking and Idle Management**: We have integrated [swayidle](https://github.com/swaywm/swayidle), [gtklock](https://github.com/jovanlanik/gtklock) or [swaylock](https://github.com/swaywm/swaylock), and [wlopm](https://git.sr.ht/~leon_plickat/wlopm/). These modern solutions leverage the `ext-session-lock` protocol, and Budgie Screensaver (our fork of gnome-screensaver) is now considered deprecated. Your screen will automatically dim and lock after inactivity, and manual locking is supported at any time.
